...
class Sky:
    ...
    def __init__(self,
        ...
        if self.nfacets!=0:
            ...
            for facet_index in range(len(self.facet_grid_regs)):
                ...
                ### todo: why the fuck are the below floats???
    ...
    def show(self,
        ...
        ax.imshow(data[0,0,:,:], vmin=vmin, vmax=vmax, origin='lower',alpha=0.1)
        if self.nfacets==0:
            ...
            if plot_facets=="all":
                ...
                #for facet_reg in self.facet_grid_regs:f
                ...
                for facet_key in plotkeys:
                    ...
                    ax.imshow(this_facet.data[datakey][0,0,:,:],
                                    transform=ax.get_transform(this_facet.gridwcs),
                                    vmin=vmin, vmax=vmax, origin="lower")
                    this_facet.grid_reg.plot(ax=ax)
        ax.imshow(data[0,0,:,:], vmin=vmin, vmax=vmax, origin='lower',alpha=0.6)
        self.grid_reg.plot(ax=ax)
        plt.show()
    ...
    def generate_facet_regions(self):
        ...
        for i in range(self.nfacets**2):
            ...
            # grid_reg = regions.PolygonPixelRegion(vertices=self.facetvertices[i],
            #                                       visual=reg_visuals)
